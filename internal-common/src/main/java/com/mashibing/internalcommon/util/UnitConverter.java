 ...
 * @author zhao.song
 * @version 1.0
 * @since 2021/5/30 21:21
 **/
public class UnitConverter {

    /**
     * description: 将Date转换为LocalDateTime <BR>
     *
     * @param date:
     * @return  {@link LocalDateTime}
     * @author  zhao.song   2021/5/30 21:22
    */
    ...
    /**
     * description: 将Date转换为LocalDate <BR>
     *
     * @param date:
     * @return  {@link LocalDate}
     * @author  zhao.song   2021/5/30 21:23
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(kiloToMeterPrice(new BigDecimal(1000)));
    }
